...
export default function SourceSinkTable() {
    ...
    return ( <div>
        ...
        <tr>
            <td class='endtype-name'>TiDB</td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxtidbreader'}>1</Link></i></td><td></td><td></td><td></td></tr>
        <tr>
        ...
        <tr>
            <td class='endtype-name'>HDFS</td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxhdfsreader'}>1</Link></i></td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxhdfswriter'}>1</Link></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxsparkwriter'}>2</Link></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxdataxhivewriter'}>3</Link></i></td><td></td><td></td></tr>
        <tr>
        ...
        <tr>
            <td class='endtype-name'>StarRocks</td><td></td><td><i className={clsx('tis-check')}></i><i className='plugin-link datax-color'><Link to={plugins.metadata.permalink+'#comqlangtechtisplugindataxstarrocksdataxstarrockswriter'}>1</Link></i></td><td></td><td><i className={clsx('tis-check')}></i><i className='plugin-link tis-color'><Link to={plugins.metadata.permalink+'#comqlangtechtispluginsincrflinkconnectorstarrocksstarrockssinkfactory'}>1</Link></i></td></tr>
        <tr>
        ...
        <tr>
            <td class='endtype-name'>Kafka</td><td></td><td></td><td><i className={clsx('tis-check')}></i><i className='plugin-link tis-color'><Link to={plugins.metadata.permalink+'#comqlangtechasyncmessageclientkafkatikvkafkamqlistenerfactory'}>1</Link></i></td><td></td></tr>
        <tr>
