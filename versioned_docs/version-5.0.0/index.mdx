...
支持 Pipeline AI Agent 创建数据管道

<Figure img={require('./guide/pipeline-ai-agent/tis5_0_0_1.png')} />
...
<Figure img={require('./enhance-extra/incr_step_1.png')} />

设置Source/Sink组件属性
<Figure img={require('./enhance-extra/incr_step_2.png')} />

TIS基于数据库元数据信息自动生成Flink-SQL脚本,您没看错全部脚本自动生！
<Figure img={require('./enhance-extra/incr_step_3.png')} />

实时数据通道创建完成！控制台实时显示流量，可以执行限流，启停（Pause/Resume）等操作 <Link href={require("./guide/rate-controller/index.mdx")}  >>>详细</Link>

**构建一个实时整库同步管道就这么简单！！！**

<Figure img={require('./enhance-extra/realtime_metric_show.gif')} />
