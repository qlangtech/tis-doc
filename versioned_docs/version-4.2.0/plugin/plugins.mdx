...
3. 文件格式
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@63d0e8d
...
2. index
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@60b553f
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@7a021f49
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@4e030feb
	* **说明:** 		SpringBoot配置，HTTP端口号，默认7700，不建议更改
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@37c37d67
	* **说明:** 		SpringBoot配置，HTTP端口号，默认7700，不建议更改
...
1. flinkCluster
	...
	* **说明:** 
		...
		1. 下载、解压
		   ...
		   ```shell script
		     wget http://tis-release.oss-cn-beijing.aliyuncs.com/4.2.0/tis/flink-tis-1.18.1-bin.tar.gz && rm -rf flink-tis-1.18.1 && mkdir flink-tis-1.18.1 && tar xvf flink-tis-1.18.1-bin.tar.gz -C ./flink-tis-1.18.1
		   ```
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@5ca86715
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@ef85567
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@552088cc
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@7fd3fd06
	* **说明:** 		无
...
1. 工作流名称
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@390a7532
...
1. upsertKey
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@560d6d2
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@6bc62bb9
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@4682882a
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@701c482e
	* **说明:** 		选择列作为表的主键
