...
1. 主键
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@2becfd4c
...
1. 主键
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@3d1c933
...
4. index
	...
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@1471b98d
...
2. serverPort
	...
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@661e279d
...
3. serverPort
	...
	* **说明:** SpringBoot配置，HTTP端口号，默认7700，不建议更改
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@621624b1
...
1. serverPort
	...
	* **说明:** SpringBoot配置，HTTP端口号，默认7700，不建议更改
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@61853c7e
...
1. flinkCluster
	...
	* **说明:** 
		...
		1. 下载、解压
		   ...
		   ```shell script
		     wget http://tis-release.oss-cn-beijing.aliyuncs.com/4.0.0-rc1/tis/flink-tis-1.13.1-bin.tar.gz && rm -rf flink-tis-1.13.1 && mkdir flink-tis-1.13.1 && tar xvf flink-tis-1.13.1-bin.tar.gz -C ./flink-tis-1.13.1
		   ```
...
1. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@52bba91a
...
1. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@7604198a
...
1. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@464aeb09
...
2. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@69bc9584
...
1. upsertKey
	...
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@f95d64d
...
2. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@25e8e59
...
2. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@6e00837f
...
2. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@5c70d7f0
...
1. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@7f5ce33e
