...
8. 兼容数据库
	...
	* **可选项说明:** 可选`MySQL`,`Oracle`,`Postgres`以下是详细说明：
		* MySQL

			<Figure img={require('./datasource_dbMode_MySQL.png')}/>
		...
		* Oracle
			...
			<Figure img={require('./datasource_dbMode_Oracle.png')}/>
		...
		* Postgres
			...
			<Figure img={require('./datasource_dbMode_Postgres.png')}/>
...
9. 读写分离
	...
	* **可选项说明:** 可选`off`,`on`以下是详细说明：
		...
		* on
			...
			<Figure img={require('./datasource_dispatch_on.png')}/>
