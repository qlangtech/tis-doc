...
1. 主键
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@4cc8d70d
...
1. 主键
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@626c569b
...
4. index
	...
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@23564dd2
...
2. serverPort
	...
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@5980fa73
...
3. serverPort
	...
	* **说明:** SpringBoot配置，HTTP端口号，默认7700，不建议更改
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@44641d6c
...
1. serverPort
	...
	* **说明:** SpringBoot配置，HTTP端口号，默认7700，不建议更改
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@27bcb4ad
...
1. flinkCluster
	...
	* **说明:** 
		...
		1. 下载、解压
		   ...
		   ```shell script
		     wget http://tis-release.oss-cn-beijing.aliyuncs.com/4.0.0/tis/flink-tis-1.18.1-bin.tar.gz && rm -rf flink-tis-1.18.1 && mkdir flink-tis-1.18.1 && tar xvf flink-tis-1.18.1-bin.tar.gz -C ./flink-tis-1.18.1
		   ```
...
1. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@e01a26b
...
1. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@2c99c8d
...
2. tabName
	...
	* **说明:** 无
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@4c5406b
...
1. upsertKey
	...
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@7308c820
...
2. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@1753475d
...
2. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@394a6d2b
...
2. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@638afcaa
...
1. 主键(s)
	...
	* **说明:** 选择列作为表的主键
	* **默认值:** com.qlangtech.tis.trigger.util.JsonUtil$UnCacheString@64c25a62
