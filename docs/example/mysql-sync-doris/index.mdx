...
只要利用[Side Outputs](Flink的https://nightlies.apache.org/flink/flink-docs-release-1.17/docs/dev/datastream/side_output/) 机制，统一启动一个Flink-CDC 的MySQL Source Connector，接收到
