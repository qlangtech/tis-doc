...
3. 文件格式
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@6a38e3d1
...
2. index
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@57ed02e6
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@2d705998
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@4dd752e8
	* **说明:** 		SpringBoot配置，HTTP端口号，默认7700，不建议更改
...
1. serverPort
	...
	* **类型:** 整型数字
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@288b73c1
	* **说明:** 		SpringBoot配置，HTTP端口号，默认7700，不建议更改
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@5dd6f517
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@33bfe6d3
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@8afce3
	* **说明:** 		无
...
1. tabName
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@2419a5db
	* **说明:** 		无
...
1. 工作流名称
	...
	* **类型:** 单行文本
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@516037be
...
1. upsertKey
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@20a4cba7
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@13ddaffb
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@40fee459
	* **说明:** 		选择列作为表的主键
...
2. 主键(s)
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@5e2718b3
	* **说明:** 		选择列作为表的主键
...
2. 主键
	...
	* **类型:** 单选
	* **必须:** 是
	* **默认值:** com.qlangtech.tis.trigger.util.UnCacheString@6c225adb
	* **说明:** 		选择列作为表的主键
