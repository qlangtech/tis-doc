...
|----------------------------------------------------------------|-----|
 ...
 | 打开 `Export To Dolphinscheduler`插件设置页面，该页面设置项比较多，下面详细说明         | <Figure img={require('./images/set_ds_plugin.png')} />         |
...
|现在可以编辑`DS endpoint`的输入项了|<Figure img={require('./images/set_endpoint.png')} />|
